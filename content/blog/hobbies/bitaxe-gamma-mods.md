...
Growing up building my own PCs, I had an idea! It's time for some thermal paste! I reached for my handy Arctic Silver, I've been using this stuff since I was a kid! Come to to realize in a pre-game discussion with ChatGPT that this would surely be conductive and as the BM1370 has exposed circuits this probably wouldn't be good. Finally AI has come through! Hah!
...
Once in-hand, I set to pry the dastardly BitAxe board from its enclosure designed for maximum brand recognition. Really it's just a 3d print case for the board. The PCB itself was simple wedged into 4 pegs on the corner, I pried this up with a tiny screw driver and only managed to break 2 of the pegs, sweet!

{{ figure(src="/images/hobbies/bitaxe-gamma-mods/p1.jpg", alt="Eek, it broke...", caption="The left pegs broke off. I would take another non-blurry photo but I might break the last 2 pegs. ;)", width=480) }}

Once that disaster was over, I could finally access the back of the board to remove the stock heat-sink and clean off that chip. ChatGPT said it would be small, I usually on CPUs so this was smaller than usual. The paste looked like cheap glue that had been blobbed on. I swiftly cleaned it off with some 99% Isopropyl. 
...
This did wonders! My temps dropped 10-15C and I could finally run at stock 525MHz, 1.15V! But is stock good enough? It's not... I found out on Alibaba Express you can order single and quad core units with liquid cooling! Well damn! Time to see how far we can go on air alone!

Using a laser thermometer I identified the warmest regions of the board, and placed some wonderful copper heat-sinks bought for a Raspberry Pi 4. Here's where they ended up:
...
Now things were looking nice, temps kept dropping and I kept turning up them volts until it couldn't take it anymore! The 120mm fan I settled on is a variable 3V-12V fan, currently around 5V I can max out temps at 750Mhz 1.18V. Pushing 12V, and a lot of noise, I can hit 775 1.19V with 0 errors. The temperatures will rise unless my apartment is under 70F, not possible, but the chip seems to be capable of it!
